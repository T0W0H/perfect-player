...
/**
 * 从 2025-26 真实赛季数据重新推导全联盟属性。
 *
 * 注意：这个脚本会**整个重写** assets/js/current-player-ratings-2026.js，
 * 跑完之后必须再跑一次 node tools/merge_2k_ratings.mjs，
 * 否则 HAN / CLU 的 2K 形状会被冲掉（脚本会提醒你）。
 */
...
console.log('\n提醒：HAN / CLU 的 2K 形状已被本次重写冲掉，请接着跑 node tools/merge_2k_ratings.mjs。');
